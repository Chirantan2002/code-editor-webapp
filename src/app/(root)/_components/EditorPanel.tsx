...
import { RotateCcw, ShareIcon, TypeIcon } from "lucide-react";
...
const EditorPanel = () => {
  ...
  const editor = useCodeEditorStore((state) => state.editor);
  ...
  return (
    ...
    <div className="relative">
      <div className="relative bg-[#12121a]/90 backdrop-blur rounded-xl border border-white/[0.05] p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg overflow-clip bg-gradient-to-r from-blue-500 to-blue-600 opacity-90 hover:opacity-100 transition-opacity cursor-pointer"
            >
        ...
        {/* Editor Container */}
        <div className="relative group rounded-lg overflow-clip ring-1 ring-white/[0.05]">
          {clerk.loaded && (
            <Editor
              height="600px"
          ...
          {!clerk.loaded && <EditorViewSkeleton />}
        </div>
      </div>
    </div>
  );
