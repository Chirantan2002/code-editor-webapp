    ...
    <div className="py-1.5">
      <div className="relative" ref={dropdownRef}>
        <motion.button
          ...
          className="w-48 group relative flex items-center gap-2 px-4 py-2.5 bg-[#1e1e1e]/80 hover:bg-[#262637] rounded-lg transition-all duration-200 border border-gray-800/50 hover:border-gray-700 cursor-pointer"
        >
          ...
          <span className="text-gray-300 min-w-[80px] text-left group-hover:text-white transition-colors text-sm">
            {currentTheme?.label}
          </span>
          ...
          {isOpen && (
            ...
            >
              <div className="px-2 pb-2 mb-2 border-b border-gray-800/50">
                <p className="text-md font-medium text-gray-400 px-2">
                  Select Theme
                </p>
              </div>
              ...
              {THEMES.map((t, index) => (
                <motion.button
                  ...
                  className={`relative cursor-pointer group w-full flex items-center gap-3 px-3 py-2.5 hover:bg-[#262637] transition-all duration-200
