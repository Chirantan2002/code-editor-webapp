    ...
    >
      ...
      {/* {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-[#232334] rounded-xl p-6 w-full max-w-xs shadow-xl flex flex-col items-center">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="cursor-pointer px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-500 transition"
              >
                Cancel
              </button>
            </div>
